...
urlpatterns = [
    ...
    path(
        "getStartTimerTwoCodes",
        views.getStartTimerTwoCodes,
        name="getStartTimerTwoCodes",
    ),
    ...
    path("getEvent3Code", views.getEvent3Code, name="getEvent3Code"),
    path("starEvent1", views.starEvent1, name="starEvent1"),
    path("starEvent2", views.starEvent2, name="starEvent2"),
    path("starEvent3", views.starEvent3, name="starEvent3"),
    ...
    path(
        "setSubscriptionPrice", views.setSubscriptionPrice, name="setSubscriptionPrice"
    ),
    ...
    path(
        "getTicketsubscriPrices",
        views.getTicketsubscriPrices,
        name="getTicketsubscriPrices",
    ),
