...
const text_D1 = document.getElementsByClassName("test_D")[0];
const text_D2 = document.getElementsByClassName("test_D")[1];
const text_D3 = document.getElementsByClassName("test_D")[2];
const text_D4 = document.getElementsByClassName("test_D")[3];
const text_D5 = document.getElementsByClassName("test_D")[4];

const text_D1_text = "TEST DETAILS";
const text_D2_text = "TIME UP !!!";
const text_D3_text = "WPM : ";
const text_D4_text = "CPM : ";
const text_D5_text = "MISTAKES : ";
...
function saveDetails() {
  ...
  typeText1(text_D1, text_D1_text);
  typeText1(text_D2, text_D2_text);
  typeText1(text_D3, text_D3_text);
  typeText1(text_D4, text_D4_text);
  typeText1(text_D5, text_D5_text);
