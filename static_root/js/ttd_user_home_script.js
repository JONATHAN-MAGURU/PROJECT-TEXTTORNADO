...
const history2 = document.getElementsByClassName("history2")[0];
...
const change_pass2 = document.getElementsByClassName("change_pass")[1];
...
const tabClock = document.getElementsByClassName("fa-clock")[1];
...
tabClock.addEventListener("click", () => {
  if (isClicked4) {
    ...
    document.querySelector(".container_B").style.width = "50%";
    options_notf.style.display = "none";
  } else {
    document.querySelector(".container_B").style.display = "none";
    document.querySelector(".container_B").style.width = "0%";
  }
  isClicked4 = !isClicked4;
});

function openCommentss() {
  options_comments.style.display = "block";
  options.style.display = "none";
  options_player.style.top = "-60vh";
...
document.querySelector(".customerCare2").addEventListener("click", function () {
...
document.querySelector(".customerCare3").addEventListener("click", function () {
  settings_container2.style.width = "40%";
  options.style.display = "none";
  settings_container.style.width = "0%";
  settings_container4.style.width = 0;
  options_comments.style.display = "none";
...
logout.addEventListener("click", function () {
  ...
  options_logout.style.opacity = "1";
...
options_logout_1_1.addEventListener("click", function () {
  options_logout.style.width = 0;
  options_logout.style.opacity = 0;
...
manage_account.addEventListener("click", function () {
  manage_account_holder.style.width = "30%";
...
document.querySelector(".upload").addEventListener("click", function () {
  change_pass2.style.maxHeight = "300px";
  change_pass2.style.opacity = "1";
});
document.querySelector(".manage_close2").addEventListener("click", function () {
  change_pass2.style.maxHeight = "0";
  change_pass2.style.opacity = "0";
});
...
function removeResHold() {
  tips.style.display = "none";
  start.style.background = "orange";
  document.querySelector(".resCover").style.display = "none";
...
function processPayment(ticketb, amountb) {
  ...
  xhr.open("POST", urlpatterns1747[3], true);
  ...
  xhr.onload = function () {
    if (xhr.status === 200) {
      ...
      notText2.innerHTML = xhr.responseText;
...
function callNotification() {
  ...
  notificationsmob.style.top = "2px";
  notText2.innerHTML = warning;
  setTimeout(closeNotification, 5000);
  notifications.style.width = "40%";
  notifications.style.opacity = "1";
  document.querySelector("#notText").innerHTML = warning;
}
...
const cont_bttn = document.getElementsByClassName("cont_btn")[0];

cont_bttn.addEventListener("click", () => {
  cont_bttn.disabled;
  cont_bttn.style.cursor = "not-allowed";
  cont_bttn.style.background = "gray";
  setTimeout(reverseContBtn, 10000);
});

reverseContBtn = () => {
  cont_bttn.disabled = false;
  cont_bttn.style.cursor = "pointer";
  cont_bttn.style.background = "orange";
};
