...
const partz = document.querySelector(".partz");
const contbt = document.querySelector("#contbt");

callCongra = () => {
  partz.style.display = "none";
  congra.style.height = "70vh";
};
...
const createAccountLink = document.getElementById("createAccountLink4");
